...
service ApiService {
    // 获取节点列表
    lytest.ListLogPathNodeResponse ListLogPathNode(1: lytest.ListLogPathNodeRequest req) throws (1: common.Error err) (api.post="/test/list", api.name="测试测试_lytest")
    // 搜索实例日志目录
    lytest.SearchLogPathResponse SearchLogPath(1: lytest.SearchLogPathRequest req) throws (1: common.Error err) (api.post="/test/search", api.name="测试测试_lytest")
    // 获取下载列表
    lytest.ListLogFileDownloadResponse ListLogFileDownload(1: lytest.ListLogFileDownloadRequest req) throws (1: common.Error err) (api.post="/test/get", api.name="测试测试_lytest")
    // 创建日志下载记录
    lytest.CreateLogFileDownloadResponse CreateLogFileDownload(1: lytest.CreateLogFileDownloadRequest req) throws (1: common.Error err) (api.post="/test/create", api.name="测试测试_lytest")
    // 更新日志下载记录
    lytest.UpdateLogFileDownloadResponse UpdateLogFileDownload(1: lytest.UpdateLogFileDownloadRequest req) throws (1: common.Error err) (api.post="/test/update", api.name="测试测试_lytest")
    // 删除日志下载记录
    lytest.DeleteLogFileDownloadResponse DeleteLogFileDownload(1: lytest.DeleteLogFileDownloadRequest req) throws (1: common.Error err) (api.post="/test/delete", api.name="测试测试_lytest")
    // 批量获取日志目录文件
