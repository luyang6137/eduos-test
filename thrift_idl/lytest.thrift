...
service ApiService {
    ...
    // 相同请求方式及请求路径测试
    admin_user.CreateAdminUserResponse2 CreateAdminUser2(1: admin_user.CreateAdminUserRequest2 req) 
    // 相同请求方式及请求路径测试2
    admin_user.CreateAdminUserResponse3 CreateAdminUser3(1: admin_user.CreateAdminUserRequest3 req) 
}
